            ...
            child: Column(
              ...
              children: [
                ...
                if (eventProofUrl != null) ...[
                  ...
                  const SizedBox(height: 6),
                  SizedBox(height: 120, child: _buildPreviewImage(eventProofUrl)),
                  const SizedBox(height: 8),
                ],
                ...
                if ((r["idDocumentUrl"] ?? r["id_document_url"]) != null) ...[
                  ...
                  const SizedBox(height: 6),
                  SizedBox(height: 150, child: _buildPreviewImage(r["idDocumentUrl"] ?? r["id_document_url"])),
                  const SizedBox(height: 8),
                ],
                ...
                if ((r["selfieUrl"] ?? r["selfie_url"]) != null) ...[
                  ...
                  const SizedBox(height: 6),
                  SizedBox(height: 150, child: _buildPreviewImage(r["selfieUrl"] ?? r["selfie_url"])),
                  const SizedBox(height: 8),
                ],
              ],
            ),
